...
{/* form */}
    ...
    <input type="email" placeholder='Your Email' className="mt-2 rounded-lg border md:w-1/2 w-full border-black bg-white px-5 py-2.5  focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" />
    
</div>

<div className='flex justify-center items-center mb-5'>

    <input type="password" placeholder='Your Password' className="mt-2 rounded-lg border md:w-1/2 w-full border-black bg-white px-5 py-2.5  focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" />
