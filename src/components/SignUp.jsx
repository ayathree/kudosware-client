...
<div className='flex justify-center items-center mb-5'>
    ...
    <input type="email" placeholder='Your Full Name' className="mt-2 rounded-lg border w-1/2 border-black bg-white px-5 py-2.5  focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" />
